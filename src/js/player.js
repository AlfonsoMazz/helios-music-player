...
export function initPlayer(audioPlayer, appState, updateSidebarCallback, updateMainViewCallback) {
    ...
    function toggleShuffle() {
       ...
       if (appState.isShuffled && appState.playingContext && appState.playingContext.path) {
    ...
    window.addEventListener('click', (e) => {
        ...
        if (queuePanel && queuePanel.classList.contains('visible') && !queuePanel.contains(e.target) && e.target !== queueBtn && !queueBtn.contains(e.target)) {
