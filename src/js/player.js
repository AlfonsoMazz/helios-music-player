// src/js/player.js
export function initPlayer(audioPlayer, appState, updateSidebarCallback, updateMainViewCallback, updateQueueCallback) {
    ...
    // --- Elementos para la notificación de error ---
    ...
    audioPlayer.addEventListener('error', (e) => {
        ...
        showErrorToast("Error de archivo. Saltando a la siguiente...");
        // Damos un pequeño respiro para que el usuario vea el mensaje antes de saltar
        setTimeout(() => {
            playNext();
        }, 500);
    });
